...
////                String path=tv_title.getText().toString().trim();
//                String path=tv_title.getText().toString().trim();
//                String asPath=path;
//                if(path.contains("/")){
//                    asPath=path.substring(path.toString().indexOf("/")+1,path.toString().length());
//                }
//                System.out.println("tag -n 12-27  cFolder-->"+tv_title.getText().toString());
//                System.out.println("tag -n 12-27  cFolder-->"+cFolder.getName());
//                System.out.println("tag -n 12-27  cFolders-->"+tv_title.getText().toString()+cFolder.getName());
//                System.out.println("tag -n 12-27  asPath-->"+asPath);
//                System.out.println("tag -n 12-27  filename-->"+file.getName());
            ...
            if (lastName.equals(".doc") || lastName.equals(".docx")) {
                Intent intent = new Intent(this, BtonThere.class);
                intent.putExtra("file", file.getName());
                startActivity(intent);
            }
